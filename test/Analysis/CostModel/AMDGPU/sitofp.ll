...
; ALL: 'sitofp_i32_to_f32'
; ALL: estimated cost of 1 for {{.*}} sitofp i32 %val to float
...
; ALL: 'sitofp_v32i32_to_v32f32'
; ALL: estimated cost of 32 for {{.*}} sitofp <32 x i32> %val to <32 x float>
...
; ALL: 'sitofp_i64_to_f32'
; FASTF64: estimated cost of 22 for {{.*}} sitofp i64 %val to float
; SLOWF64: estimated cost of 25 for {{.*}} sitofp i64 %val to float
...
; ALL: 'sitofp_i32_to_f64'
; FASTF64: estimated cost of 2 for {{.*}} sitofp i32 %val to double
; SLOWF64: estimated cost of 3 for {{.*}} sitofp i32 %val to double
...
; ALL: 'sitofp_i64_to_f64'
; FASTF64: estimated cost of 8 for {{.*}} sitofp i64 %val to double
; SLOWF64: estimated cost of 12 for {{.*}} sitofp i64 %val to double
...
; ALL: 'sitofp_v3i64_to_v3f64'
; FASTF64: estimated cost of 24 for {{.*}} sitofp <3 x i64> %val to <3 x double>
; SLOWF64: estimated cost of 36 for {{.*}} sitofp <3 x i64> %val to <3 x double>
