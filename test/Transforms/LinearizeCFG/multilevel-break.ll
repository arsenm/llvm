...
; CHECK-NEXT:    [[PREV_GUARD4:%.*]] = icmp eq i32 2, 2
...
; CHECK-NEXT:    [[GUARD_VAR5:%.*]] = phi i32 [ 2, [[NODEBLOCK_GUARD]] ], [ [[NODEBLOCK_SUCC_ID]], [[NODEBLOCK]] ]
...
; CHECK-NEXT:    [[PREV_GUARD10:%.*]] = icmp eq i32 [[GUARD_VAR8:%.*]], 4
; CHECK-NEXT:    br i1 [[PREV_GUARD10]], label [[LEAFBLOCK:%.*]], label [[NEWDEFAULT_GUARD:%.*]]
; CHECK:       LeafBlock:
...
; CHECK:       case0.guard:
; CHECK-NEXT:    [[GUARD_VAR13:%.*]] = phi i32 [ 8, [[NEWDEFAULT:%.*]] ], [ [[GUARD_VAR11:%.*]], [[NEWDEFAULT_GUARD]] ]
; CHECK-NEXT:    [[BE_GUARD14:%.*]] = icmp eq i32 [[GUARD_VAR13]], 5
; CHECK-NEXT:    br i1 [[BE_GUARD14]], label [[CASE0:%.*]], label [[CASE0_BB1_GUARD_CRIT_EDGE]]
; CHECK:       case0:
...
; CHECK-NEXT:    [[GUARD_VAR15:%.*]] = phi i32 [ [[GUARD_VAR13]], [[CASE0_GUARD:%.*]] ], [ [[CASE0_SUCC_ID]], [[CASE0]] ]
; CHECK-NEXT:    [[PREV_GUARD16:%.*]] = icmp eq i32 [[GUARD_VAR15]], 1
; CHECK-NEXT:    br i1 [[PREV_GUARD16]], label [[BB1]], label [[BB9_GUARD:%.*]]
; CHECK:       case1.guard:
; CHECK-NEXT:    [[GUARD_VAR7:%.*]] = phi i32 [ [[GUARD_VAR5]], [[LEAFBLOCK1_GUARD]] ], [ [[LEAFBLOCK1_SUCC_ID]], [[LEAFBLOCK1]] ]
...
; CHECK-NEXT:    [[GUARD_VAR8]] = phi i32 [ [[GUARD_VAR7]], [[CASE1_GUARD]] ], [ [[CASE1_SUCC_ID]], [[CASE1]] ]
; CHECK-NEXT:    [[PREV_GUARD9:%.*]] = icmp eq i32 [[GUARD_VAR8]], 1
; CHECK-NEXT:    br i1 [[PREV_GUARD9]], label [[BB1]], label [[LEAFBLOCK_GUARD:%.*]]
; CHECK:       NewDefault.guard:
; CHECK-NEXT:    [[GUARD_VAR11]] = phi i32 [ [[GUARD_VAR8]], [[LEAFBLOCK_GUARD]] ], [ [[LEAFBLOCK_SUCC_ID]], [[LEAFBLOCK]] ]
; CHECK-NEXT:    [[PREV_GUARD12:%.*]] = icmp eq i32 [[GUARD_VAR11]], 7
; CHECK-NEXT:    br i1 [[PREV_GUARD12]], label [[NEWDEFAULT]], label [[CASE0_GUARD]]
; CHECK:       NewDefault:
