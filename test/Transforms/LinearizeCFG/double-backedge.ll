...
; CHECK:       header0.guard:
; CHECK-NEXT:    [[LOOP_SUCC_ID15:%.*]] = phi i32 [ [[LOOP_SUCC_ID16:%.*]], [[LOOP_HEADER0_GUARD_CRIT_EDGE:%.*]] ], [ undef, [[ENTRY:%.*]] ]
; CHECK-NEXT:    [[HEADER1_LOAD11:%.*]] = phi i32 [ [[HEADER1_LOAD12:%.*]], [[LOOP_HEADER0_GUARD_CRIT_EDGE]] ], [ undef, [[ENTRY]] ]
; CHECK-NEXT:    [[GUARD_VAR37:%.*]] = phi i32 [ [[GUARD_VAR38:%.*]], [[LOOP_HEADER0_GUARD_CRIT_EDGE]] ], [ [[ENTRY_SUCC_ID]], [[ENTRY]] ]
; CHECK-NEXT:    [[PHI_PH1:%.*]] = phi i32 [ [[PHI_PH:%.*]], [[LOOP_HEADER0_GUARD_CRIT_EDGE]] ], [ undef, [[ENTRY]] ]
; CHECK-NEXT:    [[GUARD_VAR:%.*]] = phi i32 [ [[LOOP_SUCC_ID16]], [[LOOP_HEADER0_GUARD_CRIT_EDGE]] ], [ [[ENTRY_SUCC_ID]], [[ENTRY]] ]
...
; CHECK:       header1.guard:
; CHECK-NEXT:    [[BE_GUARD10:%.*]] = icmp eq i32 [[GUARD_VAR4:%.*]], 2
...
; CHECK:       header1.split:
; CHECK-NEXT:    [[HEADER1_LOAD13:%.*]] = phi i32 [ [[HEADER1_LOAD12]], [[HEADER1_GUARD:%.*]] ], [ [[HEADER1_LOAD]], [[HEADER1]] ]
; CHECK-NEXT:    [[LAST:%.*]] = icmp eq i32 [[GUARD_VAR4]], 3
; CHECK-NEXT:    br i1 [[LAST]], label [[LOOP_GUARD]], label [[HEADER1]]
; CHECK:       loop.guard:
; CHECK-NEXT:    [[LOOP_SUCC_ID14:%.*]] = phi i32 [ [[LOOP_SUCC_ID16]], [[HEADER1_SPLIT]] ], [ [[LOOP_SUCC_ID15]], [[HEADER0]] ], [ [[LOOP_SUCC_ID15]], [[HEADER0_GUARD]] ]
; CHECK-NEXT:    [[HEADER1_LOAD12]] = phi i32 [ [[HEADER1_LOAD13]], [[HEADER1_SPLIT]] ], [ [[HEADER1_LOAD11]], [[HEADER0]] ], [ [[HEADER1_LOAD11]], [[HEADER0_GUARD]] ]
; CHECK-NEXT:    [[GUARD_VAR36:%.*]] = phi i32 [ [[GUARD_VAR38]], [[HEADER1_SPLIT]] ], [ [[GUARD_VAR37]], [[HEADER0]] ], [ [[GUARD_VAR37]], [[HEADER0_GUARD]] ]
; CHECK-NEXT:    [[GUARD_VAR2:%.*]] = phi i32 [ [[GUARD_VAR38]], [[HEADER1_SPLIT]] ], [ 3, [[HEADER0]] ], [ [[GUARD_VAR]], [[HEADER0_GUARD]] ]
; CHECK-NEXT:    [[PHI_PH]] = phi i32 [ [[HEADER1_LOAD13]], [[HEADER1_SPLIT]] ], [ [[HEADER0_LOAD]], [[HEADER0]] ], [ [[PHI_PH1]], [[HEADER0_GUARD]] ]
...
; CHECK-NEXT:    [[LOOP_SUCC_ID16]] = phi i32 [ [[LOOP_SUCC_ID14]], [[LOOP_GUARD]] ], [ [[LOOP_SUCC_ID]], [[LOOP]] ]
