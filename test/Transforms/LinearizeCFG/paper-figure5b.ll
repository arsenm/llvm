...
; CHECK-NEXT:    [[I9:%.*]] = phi i32 [ [[I10:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
...
; CHECK:       b3.guard:
; CHECK-NEXT:    [[I10]] = phi i32 [ [[I9]], [[B2_GUARD]] ], [ [[I]], [[B2]] ]
...
; CHECK-NEXT:    [[I_INC:%.*]] = add nsw i32 [[I10]], 1
...
; CHECK:       b5.guard:
; CHECK-NEXT:    [[PREV_GUARD7:%.*]] = icmp eq i32 [[GUARD_VAR4]], 5
...
; CHECK:       b6.guard:
; CHECK-NEXT:    [[GUARD_VAR8:%.*]] = phi i32 [ [[GUARD_VAR4]], [[B5_GUARD]] ], [ 6, [[B5]] ]
; CHECK-NEXT:    [[LAST:%.*]] = icmp eq i32 [[GUARD_VAR8]], 6
...
; TODO: Test with this branch swapped
...
; CHECK-NEXT:    br label [[B6_GUARD]]
; CHECK:       b4.guard:
; CHECK-NEXT:    [[GUARD_VAR7:%.*]] = phi i32 [ 7, [[B6:%.*]] ], [ [[GUARD_VAR5:%.*]], [[B6_GUARD]] ]
; CHECK-NEXT:    [[LAST:%.*]] = icmp eq i32 [[GUARD_VAR7]], 4
; CHECK-NEXT:    br i1 [[LAST]], label [[B4:%.*]], label [[EXIT:%.*]]
; CHECK:       b4:
; CHECK-NEXT:    [[BE_GUARD:%.*]] = icmp eq i32 [[GUARD_VAR7]], 4
; CHECK-NEXT:    br i1 [[BE_GUARD]], label [[B4_SPLIT8:%.*]], label [[B4_SPLIT]]
; CHECK:       b4.split8:
; CHECK-NEXT:    store volatile i32 4, i32 addrspace(1)* undef
; CHECK-NEXT:    [[I_INC:%.*]] = add nsw i32 [[I10]], 1
; CHECK-NEXT:    br label [[B4_SPLIT]]
; CHECK:       b4.split:
; CHECK-NEXT:    [[I_INC12]] = phi i32 [ [[I_INC11]], [[B4]] ], [ [[I_INC]], [[B4_SPLIT8]] ]
; CHECK-NEXT:    br label [[B2_GUARD]]
; CHECK:       b5.guard:
; CHECK-NEXT:    [[I10]] = phi i32 [ [[I9]], [[B2_GUARD]] ], [ [[I]], [[B2]] ]
; CHECK-NEXT:    [[GUARD_VAR1]] = phi i32 [ [[GUARD_VAR]], [[B2_GUARD]] ], [ [[TMP0]], [[B2]] ]
...
; CHECK-NEXT:    br label [[B2_GUARD:%.*]]
; CHECK:       b2.guard:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[TMP12:%.*]], [[B4_SPLIT:%.*]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[I_INC19:%.*]] = phi i32 [ [[I_INC20:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[TMP1:%.*]] = phi i32 [ [[TMP7:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[I17:%.*]] = phi i32 [ [[I18:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[GUARD_VAR:%.*]] = phi i32 [ 2, [[B4_SPLIT]] ], [ 2, [[B1]] ]
; CHECK-NEXT:    [[I_PH:%.*]] = phi i32 [ [[I_INC20]], [[B4_SPLIT]] ], [ 0, [[B1]] ]
; CHECK-NEXT:    [[PREV_GUARD:%.*]] = icmp eq i32 [[GUARD_VAR]], 2
; CHECK-NEXT:    br i1 [[PREV_GUARD]], label [[B2:%.*]], label [[B5_GUARD:%.*]]
; CHECK:       b2:
; CHECK-NEXT:    [[I:%.*]] = phi i32 [ [[I_PH]], [[B2_GUARD]] ]
...
; CHECK-NEXT:    br label [[B5_GUARD]]
; CHECK:       b3.guard:
; CHECK-NEXT:    [[PREV_GUARD7:%.*]] = icmp eq i32 [[GUARD_VAR4:%.*]], 3
; CHECK-NEXT:    br i1 [[PREV_GUARD7]], label [[B3:%.*]], label [[B6_GUARD:%.*]]
; CHECK:       b3:
; CHECK-NEXT:    store volatile i32 3, i32 addrspace(1)* undef
; CHECK-NEXT:    [[COND1:%.*]] = load volatile i1, i1 addrspace(1)* undef
; CHECK-NEXT:    [[TMP3:%.*]] = select i1 [[COND1]], i32 4, i32 8
; CHECK-NEXT:    br label [[B6_GUARD]]
; CHECK:       inner.loop.guard:
; CHECK-NEXT:    [[TMP4:%.*]] = phi i32 [ [[TMP1]], [[B6:%.*]] ], [ [[TMP1]], [[B6_GUARD]] ], [ [[TMP6:%.*]], [[INNER_LOOP_INNER_LOOP_GUARD_CRIT_EDGE:%.*]] ]
; CHECK-NEXT:    [[GUARD_VAR10:%.*]] = phi i32 [ 9, [[B6]] ], [ [[GUARD_VAR8:%.*]], [[B6_GUARD]] ], [ [[TMP6]], [[INNER_LOOP_INNER_LOOP_GUARD_CRIT_EDGE]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = select i1 [[INNER_COND]], i32 4, i32 5
...
; CHECK-NEXT:    [[TMP6]] = phi i32 [ [[TMP4]], [[INNER_LOOP_GUARD:%.*]] ], [ [[TMP5]], [[INNER_LOOP]] ]
; CHECK-NEXT:    [[GUARD_VAR12:%.*]] = phi i32 [ [[GUARD_VAR10]], [[INNER_LOOP_GUARD]] ], [ [[TMP5]], [[INNER_LOOP]] ]
; CHECK-NEXT:    [[PREV_GUARD13:%.*]] = icmp eq i32 [[GUARD_VAR12]], 4
; CHECK-NEXT:    br i1 [[PREV_GUARD13]], label [[INNER_LOOP_GUARD]], label [[B4_GUARD]]
; CHECK:       b4.guard:
; CHECK-NEXT:    [[TMP7]] = phi i32 [ [[TMP6]], [[INNER_LOOP_INNER_LOOP_GUARD_CRIT_EDGE]] ], [ [[TMP5]], [[INNER_LOOP]] ]
; CHECK-NEXT:    [[GUARD_VAR14:%.*]] = phi i32 [ [[GUARD_VAR12]], [[INNER_LOOP_INNER_LOOP_GUARD_CRIT_EDGE]] ], [ [[TMP5]], [[INNER_LOOP]] ]
; CHECK-NEXT:    [[LAST:%.*]] = icmp eq i32 [[GUARD_VAR14]], 5
; CHECK-NEXT:    br i1 [[LAST]], label [[B4:%.*]], label [[EXIT:%.*]]
; CHECK:       b4:
; CHECK-NEXT:    [[BE_GUARD16:%.*]] = icmp eq i32 [[GUARD_VAR14]], 5
; CHECK-NEXT:    br i1 [[BE_GUARD16]], label [[B4_SPLIT15:%.*]], label [[B4_SPLIT]]
; CHECK:       b4.split15:
; CHECK-NEXT:    store volatile i32 4, i32 addrspace(1)* undef
; CHECK-NEXT:    [[I_INC:%.*]] = add nsw i32 [[I18]], 1
; CHECK-NEXT:    br label [[B4_SPLIT]]
; CHECK:       b4.split:
; CHECK-NEXT:    [[I_INC20]] = phi i32 [ [[I_INC19]], [[B4]] ], [ [[I_INC]], [[B4_SPLIT15]] ]
; CHECK-NEXT:    br label [[B2_GUARD]]
; CHECK:       b5.guard:
; CHECK-NEXT:    [[TMP8:%.*]] = phi i32 [ [[TMP0]], [[B2_GUARD]] ], [ [[TMP11:%.*]], [[LOOP2_BODY_B5_GUARD_CRIT_EDGE:%.*]] ], [ [[TMP0]], [[B2]] ]
; CHECK-NEXT:    [[I18]] = phi i32 [ [[I17]], [[B2_GUARD]] ], [ [[I18]], [[LOOP2_BODY_B5_GUARD_CRIT_EDGE]] ], [ [[I]], [[B2]] ]
; CHECK-NEXT:    [[GUARD_VAR1:%.*]] = phi i32 [ [[GUARD_VAR]], [[B2_GUARD]] ], [ [[TMP11]], [[LOOP2_BODY_B5_GUARD_CRIT_EDGE]] ], [ [[TMP2]], [[B2]] ]
; CHECK-NEXT:    [[PREV_GUARD2:%.*]] = icmp eq i32 [[GUARD_VAR1]], 6
; CHECK-NEXT:    br i1 [[PREV_GUARD2]], label [[B5:%.*]], label [[LOOP2_BODY_GUARD:%.*]]
; CHECK:       b5:
; CHECK-NEXT:    store volatile i32 5, i32 addrspace(1)* undef
; CHECK-NEXT:    [[COND2:%.*]] = load volatile i1, i1 addrspace(1)* undef
; CHECK-NEXT:    [[TMP9:%.*]] = select i1 [[COND2]], i32 7, i32 8
; CHECK-NEXT:    br label [[LOOP2_BODY_GUARD]]
; CHECK:       loop2.body.guard:
; CHECK-NEXT:    [[GUARD_VAR3:%.*]] = phi i32 [ [[GUARD_VAR1]], [[B5_GUARD]] ], [ [[TMP9]], [[B5]] ]
...
; CHECK-NEXT:    [[TMP10:%.*]] = select i1 [[COND3]], i32 7, i32 8
; CHECK-NEXT:    br i1 [[COND3]], label [[LOOP2_BODY_B5_GUARD_CRIT_EDGE]], label [[B6_GUARD]]
; CHECK:       loop2.body.b5.guard_crit_edge:
; CHECK-NEXT:    [[TMP11]] = phi i32 [ [[TMP8]], [[LOOP2_BODY_GUARD]] ], [ [[TMP10]], [[LOOP2_BODY]] ]
; CHECK-NEXT:    [[GUARD_VAR4]] = phi i32 [ [[GUARD_VAR3]], [[LOOP2_BODY_GUARD]] ], [ [[TMP10]], [[LOOP2_BODY]] ]
; CHECK-NEXT:    [[PREV_GUARD5:%.*]] = icmp eq i32 [[GUARD_VAR4]], 6
; CHECK-NEXT:    br i1 [[PREV_GUARD5]], label [[B5_GUARD]], label [[B3_GUARD:%.*]]
; CHECK:       b6.guard:
; CHECK-NEXT:    [[TMP12]] = phi i32 [ [[TMP11]], [[B3_GUARD]] ], [ [[TMP11]], [[B3]] ], [ [[TMP10]], [[LOOP2_BODY]] ]
; CHECK-NEXT:    [[GUARD_VAR8]] = phi i32 [ [[GUARD_VAR4]], [[B3_GUARD]] ], [ [[TMP3]], [[B3]] ], [ [[TMP10]], [[LOOP2_BODY]] ]
...
; CHECK-NEXT:    store volatile i32 [[B1_PHI]], i32 addrspace(1)* undef
; CHECK-NEXT:    [[B1_LOAD:%.*]] = load volatile i32, i32 addrspace(1)* undef
; CHECK-NEXT:    br label [[B2_GUARD:%.*]]
; CHECK:       b2.guard:
; CHECK-NEXT:    [[I_INC18:%.*]] = phi i32 [ [[I_INC19:%.*]], [[B4_SPLIT:%.*]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[B4_LOAD16:%.*]] = phi i32 [ [[B4_LOAD17:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[B2_LOAD14:%.*]] = phi i32 [ [[B2_LOAD15:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
; CHECK-NEXT:    [[I12:%.*]] = phi i32 [ [[I13:%.*]], [[B4_SPLIT]] ], [ undef, [[B1]] ]
...
; CHECK-NEXT:    store volatile i32 [[B2_PHI]], i32 addrspace(1)* undef
; CHECK-NEXT:    [[B2_LOAD:%.*]] = load volatile i32, i32 addrspace(1)* undef
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt i32 [[I]], [[N:%.*]]
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[CMP]], i32 5, i32 3
; CHECK-NEXT:    br label [[B3_GUARD]]
; CHECK:       b3.guard:
; CHECK-NEXT:    [[B2_LOAD15]] = phi i32 [ [[B2_LOAD14]], [[B2_GUARD]] ], [ [[B2_LOAD]], [[B2]] ]
; CHECK-NEXT:    [[I13]] = phi i32 [ [[I12]], [[B2_GUARD]] ], [ [[I]], [[B2]] ]
; CHECK-NEXT:    [[GUARD_VAR1:%.*]] = phi i32 [ [[GUARD_VAR]], [[B2_GUARD]] ], [ [[TMP0]], [[B2]] ]
; CHECK-NEXT:    [[PREV_GUARD2:%.*]] = icmp eq i32 [[GUARD_VAR1]], 3
; CHECK-NEXT:    br i1 [[PREV_GUARD2]], label [[B3:%.*]], label [[B4_GUARD:%.*]]
; CHECK:       b3:
; CHECK-NEXT:    [[B3_PHI:%.*]] = phi i32 [ [[B2_LOAD15]], [[B3_GUARD]] ]
; CHECK-NEXT:    store volatile i32 3, i32 addrspace(1)* undef
; CHECK-NEXT:    [[B3_LOAD:%.*]] = load volatile i32, i32 addrspace(1)* undef
; CHECK-NEXT:    [[COND1:%.*]] = load volatile i1, i1 addrspace(1)* undef
; CHECK-NEXT:    [[TMP1:%.*]] = select i1 [[COND1]], i32 4, i32 6
; CHECK-NEXT:    br label [[B4_GUARD]]
; CHECK:       b4.guard:
...
; CHECK-NEXT:    [[B4_LOAD:%.*]] = load volatile i32, i32 addrspace(1)* undef
; CHECK-NEXT:    store volatile i32 [[B4_PHI]], i32 addrspace(1)* undef
; CHECK-NEXT:    [[I_INC:%.*]] = add nsw i32 [[I13]], 1
; CHECK-NEXT:    br label [[B4_SPLIT]]
; CHECK:       b4.split:
...
; CHECK-NEXT:    [[B5_LOAD:%.*]] = load volatile i32, i32 addrspace(1)* undef
; CHECK-NEXT:    store volatile i32 [[B5_PHI]], i32 addrspace(1)* undef
; CHECK-NEXT:    br label [[B6_GUARD]]
; CHECK:       b6.guard:
; CHECK-NEXT:    [[GUARD_VAR11:%.*]] = phi i32 [ 6, [[B5]] ], [ [[GUARD_VAR4]], [[B5_GUARD]] ]
; CHECK-NEXT:    [[B6_PHI_PH:%.*]] = phi i32 [ [[B5_LOAD]], [[B5]] ], [ [[B6_PHI_PH10]], [[B5_GUARD]] ]
; CHECK-NEXT:    [[LAST:%.*]] = icmp eq i32 [[GUARD_VAR11]], 6
; CHECK-NEXT:    br i1 [[LAST]], label [[B6:%.*]], label [[EXIT:%.*]]
; CHECK:       b6:
...
b1:
  ...
  store volatile i32 %b1.phi, i32 addrspace(1)* undef
  %b1.load = load volatile i32, i32 addrspace(1)* undef
  br label %b2
...
b2:
  ...
  store volatile i32 %b2.phi, i32 addrspace(1)* undef
  %b2.load = load volatile i32, i32 addrspace(1)* undef
...
b3:
  ...
  store volatile i32 3, i32 addrspace(1)* undef
  %b3.load = load volatile i32, i32 addrspace(1)* undef
  %cond1 = load volatile i1, i1 addrspace(1)* undef
  br i1 %cond1, label %b4, label %b6

b4:
  %b4.phi = phi i32 [ %b3.load, %b3 ]
  %b4.load = load volatile i32, i32 addrspace(1)* undef
  store volatile i32 %b4.phi, i32 addrspace(1)* undef
  %i.inc = add nsw i32 %i, 1
  br label %b2

b5:
  %b5.phi = phi i32 [ %b2.load, %b2 ]
  %b5.load = load volatile i32, i32 addrspace(1)* undef
  store volatile i32 %b5.phi, i32 addrspace(1)* undef
  br label %b6
