...
; CI-LABEL: @test_atomicrmw_fmin_f32_flat(
...
; CI-NEXT:    [[NEW:%.*]] = call float @llvm.minnum.f32(float [[LOADED]], float [[VALUE:%.*]])
...
; GFX9-NEXT:    [[NEW:%.*]] = call float @llvm.minnum.f32(float [[LOADED]], float [[VALUE:%.*]])
...
; CI-LABEL: @test_atomicrmw_fmin_f32_global(
...
; CI-LABEL: @test_atomicrmw_fmin_f32_local(
...
; CI-NEXT:    ret float [[TMP6]]
;
; GFX9-LABEL: @test_atomicrmw_fmin_f32_local(
; GFX9-NEXT:    [[RES:%.*]] = atomicrmw fmin float addrspace(3)* [[PTR:%.*]], float [[VALUE:%.*]] seq_cst
...
; CI-LABEL: @test_atomicrmw_fmin_f16_flat(
; CI-NEXT:    [[RES:%.*]] = atomicrmw fmin half* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
; CI-NEXT:    ret half [[RES]]
;
; GFX9-LABEL: @test_atomicrmw_fmin_f16_flat(
; GFX9-NEXT:    [[RES:%.*]] = atomicrmw fmin half* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
...
; CI-LABEL: @test_atomicrmw_fmin_f16_global(
; CI-NEXT:    [[RES:%.*]] = atomicrmw fmin half addrspace(1)* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
; CI-NEXT:    ret half [[RES]]
;
; GFX9-LABEL: @test_atomicrmw_fmin_f16_global(
; GFX9-NEXT:    [[RES:%.*]] = atomicrmw fmin half addrspace(1)* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
; GFX9-NEXT:    ret half [[RES]]
;
...
; CI-LABEL: @test_atomicrmw_fmin_f16_local(
; CI-NEXT:    [[RES:%.*]] = atomicrmw fmin half addrspace(3)* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
; CI-NEXT:    ret half [[RES]]
;
; GFX9-LABEL: @test_atomicrmw_fmin_f16_local(
; GFX9-NEXT:    [[RES:%.*]] = atomicrmw fmin half addrspace(3)* [[PTR:%.*]], half [[VALUE:%.*]] seq_cst
; GFX9-NEXT:    ret half [[RES]]
;
...
; CI-LABEL: @test_atomicrmw_fmin_f64_flat(
; CI-NEXT:    [[TMP1:%.*]] = load double, double* [[PTR:%.*]], align 8
; CI-NEXT:    br label [[ATOMICRMW_START:%.*]]
; CI:       atomicrmw.start:
; CI-NEXT:    [[LOADED:%.*]] = phi double [ [[TMP1]], [[TMP0:%.*]] ], [ [[TMP6:%.*]], [[ATOMICRMW_START]] ]
; CI-NEXT:    [[NEW:%.*]] = call double @llvm.minnum.f64(double [[LOADED]], double [[VALUE:%.*]])
...
; GFX9-NEXT:    [[NEW:%.*]] = call double @llvm.minnum.f64(double [[LOADED]], double [[VALUE:%.*]])
...
; CI-LABEL: @test_atomicrmw_fmin_f64_global(
...
; CI-LABEL: @test_atomicrmw_fmin_f64_local(
...
; CI-NEXT:    ret double [[TMP6]]
;
; GFX9-LABEL: @test_atomicrmw_fmin_f64_local(
; GFX9-NEXT:    [[RES:%.*]] = atomicrmw fmin double addrspace(3)* [[PTR:%.*]], double [[VALUE:%.*]] seq_cst
