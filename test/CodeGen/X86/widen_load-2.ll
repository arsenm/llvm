...
; X86-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-NEXT:    movdqa {{.*#+}} xmm0 = <158,158,158,0,u,u,u,u,u,u,u,u,u,u,u,u>
; X86-NEXT:    pextrw $0, %xmm0, (%edx)
; X86-NEXT:    movb $-98, 2(%edx)
; X86-NEXT:    movdqa {{.*#+}} xmm0 = <1,1,1,0,u,u,u,u,u,u,u,u,u,u,u,u>
...
; X64-LABEL: rot:
; X64:       # BB#0: # %entry
; X64-NEXT:    movdqa {{.*#+}} xmm0 = <158,158,158,0,u,u,u,u,u,u,u,u,u,u,u,u>
; X64-NEXT:    pextrw $0, %xmm0, (%rsi)
; X64-NEXT:    movb $-98, 2(%rsi)
; X64-NEXT:    movdqa {{.*#+}} xmm0 = <1,1,1,0,u,u,u,u,u,u,u,u,u,u,u,u>
