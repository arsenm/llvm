; RUN: llc -march=r600 -mcpu=SI -verify-machineinstrs < %s | FileCheck %s -check-prefix=SI
...
ENDIF:                                            ; preds = %main_body, %Flow2
  ...
  call void @llvm.R600.store.swizzle(<4 x float> %80, i32 60, i32 1)
  ...
  call void @llvm.R600.store.swizzle(<4 x float> %84, i32 0, i32 2)
  ret void
