...
; SI: S_ENDPGM
define void @simple_write2st64_two_val_f32_2_5(float addrspace(1)* %C, float addrspace(1)* %in0, float addrspace(1)* %in1) #0 {
  %x.i = tail call i32 @llvm.r600.read.tidig.x() #1
...
; SI: S_ENDPGM
define void @simple_write2st64_two_val_max_offset_f32(float addrspace(1)* %C, float addrspace(1)* %in0, float addrspace(1)* %in1, float addrspace(3)* %lds) #0 {
  %x.i = tail call i32 @llvm.r600.read.tidig.x() #1
  %in0.gep = getelementptr float addrspace(1)* %in0, i32 %x.i
  %in1.gep = getelementptr float addrspace(1)* %in1, i32 %x.i
  %val0 = load float addrspace(1)* %in0.gep, align 4
...
; SI: S_ENDPGM
define void @simple_write2st64_two_val_max_offset_f64(double addrspace(1)* %C, double addrspace(1)* %in0, double addrspace(1)* %in1, double addrspace(3)* %lds) #0 {
  %x.i = tail call i32 @llvm.r600.read.tidig.x() #1
