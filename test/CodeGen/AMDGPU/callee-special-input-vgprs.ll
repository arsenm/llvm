...
; GCN: buffer_load_dword v33, off, s[0:3], s5 offset:8 ; 4-byte Folded Reload
...
; GCN: buffer_store_dword [[K]], off, s[0:3], s5 offset:8
; GCN: buffer_store_dword v0, off, s[0:3], s32 offset:8

; GCN: buffer_load_dword [[RELOAD_BYVAL:v[0-9]+]], off, s[0:3], s5 offset:8
; GCN: buffer_store_dword [[RELOAD_BYVAL]], off, s[0:3], s32 offset:4{{$}}
; GCN: v_mov_b32_e32 [[RELOAD_BYVAL]],
; GCN: s_swappc_b64
