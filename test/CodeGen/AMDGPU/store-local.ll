; RUN: llc -march=amdgcn -mcpu=verde -verify-machineinstrs < %s | FileCheck -check-prefixes=GCN,SICIVI,FUNC %s
...
; RUN: llc -march=r600 -mcpu=cayman < %s | FileCheck -check-prefixes=CM,FUNC %s
