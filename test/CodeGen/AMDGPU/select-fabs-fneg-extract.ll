...
; FIXME: This should invert the compare and select to shrink
; operation.
...
; GCN: v_cndmask_b32_e64 [[SELECT:v[0-9]+]], [[X]], 1.0, s
; GCN: v_add_f32_e64 v{{[0-9]+}}, |[[SELECT]]|, [[Y]]
...
; GCN-DAG: v_mov_b32_e32 [[K:v[0-9]+]], 0x44800000
; GCN: buffer_load_dword [[X:v[0-9]+]]
; GCN: buffer_load_dword [[Y:v[0-9]+]]

; GCN-DAG: v_cmp_eq_u32_e64
; GCN: v_cndmask_b32_e32 [[SELECT:v[0-9]+]], [[X]], [[K]], vcc
; GCN: v_add_f32_e64 v{{[0-9]+}}, |[[SELECT]]|, [[Y]]
...
; GCN-DAG: v_and_b32_e32 [[X:v[0-9]+]], 0x7fffffff, [[X]]
...
; GCN: v_cndmask_b32_e64 [[SELECT:v[0-9]+]], [[X]], 4.0, s
; GCN: v_mul_f32_e64 v{{[0-9]+}}, -|[[SELECT]]|, [[Y]]
