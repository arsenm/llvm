...
bool AMDGPUPromoteAlloca::doInitialization(Module &M) {
  ...
  MaxWorkGroupSizeRange = MDB.createRange(APInt(32, 0), APInt(32, 1024));
...
AMDGPUPromoteAlloca::getLocalSizeYZ(IRBuilder<> &Builder) {
  ...
  // FIXME: These seem to get stripped off when reloading the bitcode?
  DispatchPtrFn->setDoesNotAlias(0);
  DispatchPtrFn->addAttribute(AttributeSet::ReturnIndex, Attribute::NoAlias);
  DispatchPtrFn->addAttribute(AttributeSet::ReturnIndex, Attribute::NonNull);

  // Size of the dispatch packet struct.
  DispatchPtrFn->addDereferenceableAttr(AttributeSet::ReturnIndex, 64);
