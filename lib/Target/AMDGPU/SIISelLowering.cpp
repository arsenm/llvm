...
SDValue SITargetLowering::LowerParameter(SelectionDAG &DAG, EVT VT, EVT MemVT,
                                         ...
                                         unsigned Offset, unsigned BasePtrReg,
                                         bool Signed) const {
  ...
  if (!BasePtrReg)
    BasePtrReg = TRI->getPreloadedValue(MF, SIRegisterInfo::KERNARG_SEGMENT_PTR);
  ...
  SDValue BasePtr = DAG.getCopyFromReg(Chain, SL,
                                       MRI.getLiveInVirtReg(BasePtrReg), PtrVT);
...
SDValue SITargetLowering::LowerFormalArguments(
  ...
  // Maximum of 16 user SGPRs and 5 system SGPRs.

  static const MCPhysReg InputSGPRs[] = {
    ...
    AMDGPU::SGPR20, AMDGPU::SGPR21
  };

  static const MCPhysReg InputSGPR64s[] = {
    AMDGPU::SGPR0_SGPR1, AMDGPU::SGPR2_SGPR3,
    AMDGPU::SGPR4_SGPR5, AMDGPU::SGPR6_SGPR7,
    AMDGPU::SGPR8_SGPR9, AMDGPU::SGPR10_SGPR11,
    AMDGPU::SGPR12_SGPR13, AMDGPU::SGPR14_SGPR15,
    AMDGPU::SGPR16_SGPR17, AMDGPU::SGPR18_SGPR19,
    AMDGPU::SGPR20_SGPR21
  };

  static const MCPhysReg InputSGPR128s[] = {
    AMDGPU::SGPR0_SGPR1_SGPR2_SGPR3,
    AMDGPU::SGPR4_SGPR5_SGPR6_SGPR7,
    AMDGPU::SGPR8_SGPR9_SGPR10_SGPR11,
    AMDGPU::SGPR12_SGPR13_SGPR14_SGPR15,
    AMDGPU::SGPR16_SGPR17_SGPR18_SGPR19
  };
  ...
  for (unsigned i = 0, e = Ins.size(), ArgIdx = 0; i != e; ++i) {
    ...
    if (VA.isMemLoc()) {
      ...
      unsigned InputPtrReg = TRI->getPreloadedValue(
        MF, SIRegisterInfo::KERNARG_SEGMENT_PTR);
      SDValue Arg = LowerParameter(DAG, VT, MemVT,  DL, Chain,
                                   Offset, InputPtrReg, Ins[i].Flags.isSExt());
...
SDValue SITargetLowering::LowerLocalSizeIntrinsic(SelectionDAG &DAG,
  ...
  if (Subtarget->isAmdHsaOS()) {
    ...
    Param = LowerParameter(DAG, MVT::i32, MVT::i32, DL, DAG.getEntryNode(),
                           Offset, BasePtr, false);
    ...
    case 0:
      ...
      break;
    case 1:
      // Get local size y from the high bits.  We can use SRL here, because
      // the max value range is 0-256, so the sign bit will always be zero.
      Param = DAG.getNode(ISD::SRL, DL, MVT::i32, Param,
                          DAG.getConstant(16, DL, MVT::i32));
      break;
    case 2:
      // Do nothing, the 16-bits after the z dimension size are always
      // zero, so we don't need to clear them.  AssertZext will be added
      // below.
      break;
    }
  } else {

    BasePtr = TRI->getPreloadedValue(MF, SIRegisterInfo::KERNARG_SEGMENT_PTR);
  ...
  return DAG.getNode(ISD::AssertZext, DL, MVT::i32, Param,
                     DAG.getValueType(MVT::i16));
}
...
SDValue SITargetLowering::LowerINTRINSIC_WO_CHAIN(SDValue Op,
  ...
  unsigned InputPtrReg = AMDGPU::NoRegister;
  ...
  case Intrinsic::r600_read_local_size_x:
    return LowerLocalSizeIntrinsic(DAG, DL, 0);
  case Intrinsic::r600_read_local_size_y:
    return LowerLocalSizeIntrinsic(DAG, DL, 1);
  case Intrinsic::r600_read_local_size_z:
    return LowerLocalSizeIntrinsic(DAG, DL, 2);
