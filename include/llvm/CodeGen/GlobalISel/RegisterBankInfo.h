...
public:
  ...
  /// Get the cost of using \p ValMapping to decompose a register of size \p
  /// Size in bank \p CurBank according to \p ValMapping. This is similar to
  /// ::copyCost, except for cases where multiple copy-like operations need to
  /// be inserted.
